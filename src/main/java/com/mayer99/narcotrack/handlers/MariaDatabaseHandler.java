...
public class MariaDatabaseHandler implements NarcotrackEventHandler {
    ...
    public MariaDatabaseHandler(Narcotrack narcotrack) {
        ...
        try {
            ...
            eegStatement = databaseConnection.prepareStatement("INSERT INTO frame_eeg(record_id, recorded_at, frameCountPerSecond, chk_sum, checksum_valid, raw) VALUES(?, ?, ?, ?, ?, ?)");
            ...
            powerSpectrumStatement = databaseConnection.prepareStatement("INSERT INTO frame_power_spectrum(record_id, recorded_at, info, chk_sum, checksum_valid, raw) VALUES(?, ?, ?, ?, ?, ?)", Statement.RETURN_GENERATED_KEYS);
            ...
            electrodeCheckStatement = databaseConnection.prepareStatement("INSERT INTO frame_electrode_check(record_id, recorded_at, imp_1_a, imp_1_b, imp_ref, imp_2_a, imp_2_b, info, chk_sum, checksum_valid, raw) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
